def  Lucy_sem_audio():
    ...
    triste = ['eu estou mal', 'eu estou triste', 'estou chateado', 'me sinto sozinho', 'eu estou me sentindo sozinho',
              ...
              'eu estou me sentido triste', 'eu so queria ser feliz', 'como eu faço para ser feliz ?',
              'estou muito mal',
              'eu estou muito mal', 'eu estou muito triste', 'estou cansado de me sentir sozinho',
              'eu queria ser feliz',
...
def lucy_cvs():
        ...
        triste = ['eu estou mal', 'eu estou triste', 'estou chateado', 'me sinto sozinho',
                  'eu estou me sentindo sozinho',
                  'olha estou me sentido mal', 'estou cansado de passar por isso', 'eu queria morrer',
                  'eu estou me sentido triste', 'eu so queria ser feliz', 'como eu faço para ser feliz ?',
                  'estou muito mal',
                  'eu estou muito mal', 'eu estou muito triste', 'estou cansado de me sentir sozinho',
                  'eu queria ser feliz',
                  'como faço para me sentir melhor', 'ninguem me ama', 'ninguem gosta de mim',
                  'eu so queria nao estar mal',
                  'me ajuda a nao ficar mal pfv', 'que conversar ?', 'vamos conversar estou mal', 'eu estou triste ',
                  'eu estou mal ', 'eu estou chateda']
...
Lucy voice-incompleto.''')
                ...
                if escolhido == n56:
                    ...
                    triste[5] or sx == triste[6] or sx == triste[7] or sx == triste[8] or sx == triste[9] or sx == \
                    triste[
                        10] or sx == triste[11] or sx == triste[12] or sx == triste[13] or sx == triste[14] or sx == \
                    triste[
                        15] or sx == triste[16] or sx == triste[17] or sx == triste[18] or sx == triste[19] or sx == \
                    triste[
    ...
    ''')
                        ...
                        while True:
                            ...
                            if esc78 == '1':
                                ...
                                mixer.init()
                                mixer.music.load(
                                    'lc_music/Måneskin - I WANNA BE YOUR SLAVE (Official Video)(MP3_320K).mp3')
                                mixer.music.play()
                                print('Para parar a musica digite stop')
