...
#Degabiontwess 2021. Gabriel Xavier..]
...
#Lucy oficial 1.1.0._.10/10/2021.
...
[tabuada]-[raiz]-[media]-[lucy1]-[eq2grau]-[conversar]-[piada]-[mudar meu nome]'''
        ...
        while True:  #
            ...
            if sx == nome34:
                ...
                print('Boa tarde :)')
                audio_fala('Boa tarde emogi feliz')
            elif sx=='pause':
                mixer.music.pause()
                ...
                if escolhido ==n56:
                    ...
                    audio_fala('Assim, por que Napoleão era sempre chamado para as festas na França? Então, é porque ele era Bom Na Party')
                elif escolhido == n59:
                    audio_fala('Então, o que o pagodeiro foi fazer na igreja? Foi cantar Pá God')
                elif escolhido == n60:
                    audio_fala('Então quando foi que os americanos comeram carne pela primeira vez? Quando chegou Cristóvão Com Lombo.')

            elif sx==triste[0] or sx ==triste[1] or sx ==triste[2] or sx ==triste[3] or sx ==triste[4] or sx ==triste[5] or sx ==triste[6] or sx ==triste[7] or sx ==triste[8] or sx ==triste[9] or sx ==triste[10] or sx ==triste[11] or sx ==triste[12] or sx ==triste[13] or sx ==triste[14] or sx ==triste[15] or sx ==triste[16] or sx ==triste[17] or sx ==triste[18] or sx ==triste[19] or sx ==triste[20] or sx ==triste[21]  or sx == 'conversar' or sx == 'conversa' or sx == 'quero conversar':
                ...
                if ssdfr5 == 'sim' or ssdfr5 == 's':
                    ...
                    if chute == nome3:
                        ...
                        if pq == s1 or pq == 's':
                            ...
                            print('Não fique assim :(.Olha eu sei que as coisas podem estar dificies, mas tudo ira melhorar')
                            audio_fala('Não fique assim,Olha eu sei que as coisas podem estar dificies, mas tudo ira melhorar ')
                        else:
                    ...
                    lista = [n1, n2, n4]
                    escolhido = random.choice(lista)
                    print('Eu tambem gosto de {}, mas eu não posso usufruir como eu dejesaria, pois o meu criador não me deu essa opção ksksskskssk'.format(escolhido))
                    audio_fala(f'Eu também gosto de {escolhido}, mas eu não posso usufruir como eu dejesaria, pois o meu criador não me deu essa opção')
...
''')
                        ...
                        while True:
                            ...
                            if esc78 == '1':
                                ...
                                mixer.init()
                                mixer.music.load('lc_music/The Weeknd - I Feel It Coming ft. Daft Punk (Offic(MP3_160K).mp3')
                                mixer.music.play()
                                print('Para parar a musica digite stop')
                                ggh = input('==: ')
                                if ggh == 'stop' or ggh == 'pausar':
                                ...
                                mixer.init()
                                mixer.music.load('lc_music/I Follow Rivers - Lykke Li (La Vie d_Adèle_La Vida de Adele)(MP3_320K).mp3')
                                mixer.music.play()
                                print('Para parar a musica digite stop')
                                ...
                                mixer.init()
                                mixer.music.load('lc_music/kostromin _ Моя голова винтом (My head is spinning like a screw) (Official Video)(MP3_160K).mp3')
                                mixer.music.play()
                                print('Para parar a musica digite stop')
                ...
                print('{}/{}/{}'.format(atual, mes, atual2))
            elif sx=='gabriel':
                print('Gabriel é o meu criador')
                ...
                #___--___.
                '''if bs==ds:
                    audio_fala('Descupe-me,mas ainda não e possivel efetuar essa ação.talvez em próximas atualizações seja possivel')
                elif bs==ds2:
                    audio_fala('Você digitou algum comando errado')
                elif bs==ds3:
                    audio_fala('Desculpe-me comando invalido')
                elif bs==ds4:
                    audio_fala('Eu ainda não posso fazer oque você deseja')

                elif bs==ds4:
                    audio_fala('Digite relp para ver oque eu posso fazer')
                '''
                #___--___.
                print(bs)
        from time import sleep
        ...
        for contagem in range(0, 3):
            sleep(1)
        print('Lançamento lucy 1.1.0 15/09/21')
        for n in range(1, 10):
            print('.', end=' ')
            sleep(0.5)
